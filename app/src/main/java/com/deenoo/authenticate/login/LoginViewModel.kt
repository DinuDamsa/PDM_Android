...
import com.deenoo.authenticate.data.TokenHolder
...
class LoginViewModel : ViewModel() {
    ...
    private val mutableLoginResult = MutableLiveData<com.deenoo.core.Result<TokenHolder>>()
    val loginResult: LiveData<com.deenoo.core.Result<TokenHolder>> = mutableLoginResult

    fun login(username: String, password: String) {
        viewModelScope.launch {
            Log.v(TAG, "login...");
            mutableLoginResult.value = AuthenticateRepository.login(username, password)
        }
    }
